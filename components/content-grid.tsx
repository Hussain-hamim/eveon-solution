...
const contentData = [
  {
    ...
    description: "Modern, responsive websites built with cutting-edge technologies and best practices for optimal performance.",
  ...
  {
    title: "E-commerce",
    description: "Scalable online stores with secure payment processing, inventory management, and conversion optimization.",
  ...
  },
  {
    ...
    description: "Comprehensive digital transformation strategies that align technology with business goals and growth objectives.",
    imageUrl: "https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=800",
    buttonText: "Learn More"
  },
  {
    title: "Cloud Services",
    description: "Reliable cloud infrastructure and deployment solutions that scale with your business needs and requirements.",
